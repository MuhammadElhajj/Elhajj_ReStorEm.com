...
<div className='email-part'>
        <input type='email' placeholder='Type Your Email' className='inputSignin'/>
        <MdEmail className='emailIcon'/>
        </div>
        <div className='password-part'>
          
        <input type='password' placeholder='Type Your Password' className='inputSignin'/>
...
<img src = {twitterIcon} alt='p'  className='Twitter'/>
        <a className='Visitor-signin' onClick={() => {
          setSigned(prev => !prev)
